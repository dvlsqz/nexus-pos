    ...
    <form @submit.prevent="emit('submit')" class="space-y-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-1.5">
                    <Label>NIT</Label>
                    <Input v-model="form.nit" placeholder="12345678-9" class="font-mono" />
                </div>
                <div class="space-y-1.5">
                    <Label>Nombre del contacto</Label>
                    <Input v-model="form.contacto_nombre" placeholder="Persona de contacto" />
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <Input v-model="form.telefono_alt" placeholder="2222-4444" />
                </div>
                <div class="space-y-1.5">
                ...
                <div class="space-y-1.5 md:col-span-2">
                    ...
                    <Input v-model="form.website" placeholder="https://www.proveedor.com" />
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="space-y-1.5">
                    <Label>País</Label>
                    <Input v-model="form.pais" placeholder="Guatemala" />
                </div>
                <div class="space-y-1.5">
                ...
                <div class="space-y-1.5 md:col-span-3">
                    ...
                    <Input v-model="form.direccion" placeholder="Calle, Avenida, No..." />
                </div>
            </div>
        </div>
